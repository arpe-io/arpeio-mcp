...
from src.fastbcp.version import (
    VERSION_REGISTRY,
    VersionCapabilities,
...
class TestToolVersion:
    ...
    def test_parse_full_version_string(self):
        ...
        v = ToolVersion.parse("FastBCP Version 0.29.1.0")
        assert v.parts[0] == 0
        assert v.parts[1] == 29
        assert v.parts[2] == 1
        assert v.parts[3] == 0
    ...
    def test_parse_numeric_only(self):
        ...
        v = ToolVersion.parse("0.29.1.0")
        assert v == ToolVersion(parts=(0, 29, 1, 0))

    def test_parse_with_whitespace(self):
        """Test parsing a version string with leading/trailing whitespace."""
        v = ToolVersion.parse("  FastBCP Version 1.2.3.4  ")
    ...
    def test_str_representation(self):
        ...
        v = ToolVersion(parts=(0, 29, 1, 0))
        assert str(v) == "0.29.1.0"

    def test_equality(self):
        """Test equality comparison."""
        a = ToolVersion(parts=(0, 29, 1, 0))
        b = ToolVersion(parts=(0, 29, 1, 0))
        assert a == b

    def test_inequality(self):
        """Test inequality comparison."""
        a = ToolVersion(parts=(0, 29, 1, 0))
        b = ToolVersion(parts=(0, 30, 0, 0))
        assert a != b

    def test_less_than(self):
        """Test less-than comparison."""
        a = ToolVersion(parts=(0, 28, 0, 0))
        b = ToolVersion(parts=(0, 29, 1, 0))
        assert a < b
    ...
    def test_greater_than(self):
        ...
        a = ToolVersion(parts=(0, 29, 1, 0))
        b = ToolVersion(parts=(0, 28, 9, 9))
        assert a > b

    def test_comparison_across_fields(self):
        """Test comparison across major/minor/patch/build."""
        versions = [
            ToolVersion(parts=(0, 28, 0, 0)),
            ToolVersion(parts=(0, 29, 0, 0)),
            ToolVersion(parts=(0, 29, 0, 1)),
            ToolVersion(parts=(0, 29, 1, 0)),
...
class TestVersionDetector:
    ...
    def test_detect_success(self, mock_run):
        ...
        assert version == ToolVersion(parts=(0, 29, 1, 0))
...
class TestCheckVersionCompatibility:
    ...
    def test_basic_params_no_warnings(self):
        ...
        caps = VERSION_REGISTRY["0.29.1.0"]
        version = ToolVersion(parts=(0, 29, 1, 0))
